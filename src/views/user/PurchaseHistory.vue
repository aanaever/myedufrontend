<template>
    <h3 class="cart-header">История покупок</h3>
    <div class="main-view" style="height: 70vh" v-loading="isLoading">
      ...
      <div class="mobile-only">
        <small>Прокрутите страницу по горизонтали, чтобы просмотреть все столбцы</small>
      </div>
      ...
      <div v-else class="empty-view">
        <el-empty description="Вы еще ничего не купили!"></el-empty>
        <router-link to="/">
          <el-button plain class="btn purple" style="width: 15em"> Продолжить покупки </el-button>
        </router-link>
      </div>
    </div>
  </template>
  ...
  import type { Course, Sale } from "@/interfaces/myedu";
  ...
  onMounted(() => {
    document.title = "Purchase History | MyEdu";
