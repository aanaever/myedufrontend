<template>
    <h2 class="cart-header">Мое обучение</h2>
    <div class="main-view" style="height: 70vh" v-loading="isLoading">
      ...
      <h3 class="serif-head">Курсы, на которые вы записаны</h3>
      <!-- START COURSE CARD -->
      <div class="course-box">
        <el-space direction="vertical" alignment="start" :size="30" style="margin-top: 2%; margin-left: 10%">
          ...
          <el-space v-else wrap size="large" fill>
            <h4 style="margin: auto; color: grey">Вы не записаны ни на один курс.</h4>
          </el-space>
        </el-space>
      </div>
      <!-- END OF SINGLE CARD -->
  ...
  onMounted(() => {
    document.title = "My Learning | MyEdu";
    fetchAllEnrolled(0);
  });
  </script>
